...
Key findings:
	1.	Evening time blocks had the highest congestion levels.
	2.	Noon was consistently the least congested time block.
	3.	Morning periods showed low to moderate congestion.
	4.	Weekdays tended to be busier than weekends.
	5.	High congestion occurred exclusively during evening observations in the dataset.
	6.	Medium and low congestion periods were significantly more common than high congestion periods.
	7.	Multiple acceptable training windows exist for gym-goers who want to avoid crowds.
